...
**Работа рассчитана на двух человек и выполняется в три этапа:**  
- настройка  
- симуляция и обработка сбоя  
- восстановление  
...
- Развернуть Postgres на двух узлах в режиме балансировки нагрузки.  
- Использовать `pgpool-II`.  
- Продемонстрировать обработку транзакций обоими серверами.  
